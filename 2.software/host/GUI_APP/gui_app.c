...
lv_task_t *task_send = NULL;
lv_task_t *task_write = NULL;
...
void gui_app_start()
{
	...
	// task_send = lv_task_create(Send_Task_cb,5,LV_TASK_PRIO_MID,NULL);
	// task_write = lv_task_create(Store_Task_cb,60000,LV_TASK_PRIO_LOWEST,NULL);
}
